  ...
  return (
    <>
      <section className="text-center flex justify-center items-center ">
        <div className="container relative shrink my-14 py-10 px-7 max-w-[80%] md:min-h-[80%] md:max-w-[30%] md:max-h-[80%] shadow-lg  space-y-4 border border-gray-300 rounded-lg bg-white">
